...
public class PesquisaProfessor extends javax.swing.JFrame {
    ...
    public PesquisaProfessor() {
        ...
        ProfessorController c = new ProfessorController();
        lista = c.listarProfessor();
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome", "Formação", "Data de Cadastro"
            }
        ));
    ...
    private void botaoInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoInserirActionPerformed
        JanelaProfessor jc = new JanelaProfessor(model);
        jc.setVisible(true);
    ...
    private void botaoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoEditarActionPerformed
        ...
        if (selecionado >= 0) {
            ...
            JanelaAtualizaProfessor ac = new JanelaAtualizaProfessor(selecionado, cdCliente, model);
            ac.setVisible(true);
        } else {
    ...
    private void efetuaPesquisa() {
        ...
        List<Professor> lista = new ArrayList<Professor>();
        ProfessorController c = new ProfessorController();
        lista = c.listarProfessoresByNome(nome);
        model.limpar();
